...
def get_test_loader(dataset):
    ...
    test_loader = DataLoader(dataset=test_dataset, batch_size=params.batch_size, shuffle=False, num_workers=1,)
...
def get_valid_loader(dataset):
    ...
    valid_loader = DataLoader(dataset=valid_dataset, batch_size=params.batch_size, shuffle=False, num_workers=1,)
